...
Copy for portfolio case studies. Use these to populate Sanity CMS.
...
You know what's harder than building for clients? Building for your own team. Everyone has opinions, the scope creeps because "we can just add that," and there's no external deadline keeping you honest.
...
The site needed to work as hard as we do—late nights, weird edge cases, the occasional chaos. It's been live for over a year and has become our best salesperson.
...
2. **slug** - URL-friendly version (e.g., "voodoo-ranger")
3. **circularText** - The spinning text for the hero
4. **projectUrl** - Link to live site (if available)
5. **overview.headline** - The punchy headline
6. **overview.richtext** - The full description (portable text)
7. **tags** - Array of skill/tech tags
8. **featuredImage** - Thumbnail for the gallery
9. **blocks** - Additional content blocks (images, videos, etc.)

---

*Written with hiring managers in mind. They want to see:*
- *Technical skills in context*
- *Problem-solving ability*
- *Understanding of business goals*
- *Evidence you can ship real work*
- *A personality that won't make meetings painful*
