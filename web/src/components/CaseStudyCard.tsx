  ...
  return (
    ...
    >
      {linkable ? (
        ...
        <div className="w-full md:w-[60%] block">
          <div className="p-6 md:p-12 bg-background/80 backdrop-blur-md rounded-3xl border border-foreground/10 shadow-2xl group hover:bg-foreground/5 transition-colors duration-500">
            <div className="aspect-[4/3] w-full bg-foreground/10 rounded-xl mb-6 overflow-hidden relative">
              {thumbnail ? (
                <img
                  src={thumbnail}
                ...
                <>
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-foreground/5" />
                  <span className="absolute inset-0 flex items-center justify-center font-mono text-xs opacity-50 uppercase tracking-widest">Coming Soon</span>
                </>
              )}
            </div>
            <h3 className="text-2xl md:text-3xl font-bold tracking-tight">{title}</h3>
